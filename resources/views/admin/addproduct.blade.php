                ...
                <form action="/search">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="input-group-text bg-transparent text-primary">Search</button>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                                    ...
                                    <a href="cartlist" class="nav-item nav-link">Cart</a>
                                    <!-- <div class="nav-item dropdown"> -->
                                    <a href="ordernow" class="nav-item nav-link">Checkout</a> 
                                    <!-- <div class="dropdown-menu rounded-0 m-0"> -->
                                    <!-- <a href="cart" class="dropdown-item">Shopping Cart</a> -->
                                    <!-- <a href="ordernow" class="dropdown-item">Checkout</a>  -->
                                <!-- </div></div> -->
                                ...
                                <div class="nav-item dropdown">
                            @if(Session::has('dbdata'))
                                <a href="#" class="nav-link" data-toggle="dropdown">{{Session::get('dbdata')['name']}}<i class="fa fa-angle-down float-right mt-1"></i></a>
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
